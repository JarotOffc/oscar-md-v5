...
describe('Texts', () => {
    describe('Aksara Jawa', () => {
        it('Latin to Aksara', done => {
            try {
                const res = (0, index_1.latinToAksara)('hallo rek');
        ...
        it('Aksara to Latin', done => {
            try {
                const res = (0, index_1.aksaraToLatin)('ꦲꦭ꧀ꦭꦺꦴ​ꦫꦺꦏ꧀', { HVokal: false });
    ...
    describe('Bucin', () => {
        it('Bucin', done => {
            (0, index_1.bucin)().then(res => {
                (0, chai_1.expect)(res).to.be.a('string');
                return done();
            }).catch(done);
        });
        it('Bucin JSON', done => {
            const res = index_1.bucinjson;
    ...
    describe('Dare', () => {
        it('Dare', done => {
            (0, index_1.dare)().then(res => {
                (0, chai_1.expect)(res).to.be.a('string');
                return done();
            }).catch(done);
        });
        it('Dare JSON', done => {
            const res = index_1.darejson;
            (0, chai_1.expect)(res).to.be.an('array');
    ...
    describe('Truth', () => {
        it('Truth', done => {
            (0, index_1.truth)().then(res => {
                (0, chai_1.expect)(res).to.be.a('string');
                return done();
            }).catch(done);
        });
        it('Truth JSON', done => {
            const res = index_1.truthjson;
            (0, chai_1.expect)(res).to.be.an('array');
