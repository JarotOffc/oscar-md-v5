...
describe('Games', () => {
    describe('Tebakgambar', () => {
        it('tebakgambar', done => {
            (0, index_1.tebakgambar)().then(result => {
        ...
        it('tebakgambar JSON', done => {
            const res = index_1.tebakgambarjson;
    ...
    describe('Asahotak', () => {
        it('asahotak', done => {
            (0, index_1.asahotak)().then(result => {
                (0, chai_1.expect)(result).to.an('object');
                (0, chai_1.expect)(result.index).to.a('number');
    ...
    describe('Caklontong', () => {
        it('caklontong', done => {
            (0, index_1.caklontong)().then(result => {
                (0, chai_1.expect)(result).to.an('object');
                (0, chai_1.expect)(result.index).to.a('number');
                (0, chai_1.expect)(result.soal).to.a('string');
                (0, chai_1.expect)(result.jawaban).to.a('string');
        ...
        it('caklontong JSON', done => {
            let res = index_1.caklontongjson;
            (0, chai_1.expect)(res).to.an('array');
    ...
    describe('Family 100', () => {
        it('family100', done => {
            (0, index_1.family100)().then(result => {
                (0, chai_1.expect)(result).to.an('object');
                (0, chai_1.expect)(result.soal).to.a('string');
    ...
    describe('TebakKata', () => {
        it('tebakkata', done => {
            (0, index_1.tebakkata)().then(result => {
                (0, chai_1.expect)(result).to.an('object');
                (0, chai_1.expect)(result.index).to.a('number');
                (0, chai_1.expect)(result.soal).to.a('string');
                (0, chai_1.expect)(result.jawaban).to.a('string');
    ...
    describe('TebakKimia', () => {
        it('tebakkimia', done => {
            (0, index_1.tebakkimia)().then(result => {
                (0, chai_1.expect)(result).to.an('object');
        ...
        it('tebakkimia JSON', done => {
            let res = index_1.tebakkimiajson;
            (0, chai_1.expect)(res).to.an('array');
    ...
    describe('Tekateki', () => {
        it('tekateki', done => {
            (0, index_1.tekateki)().then(result => {
                (0, chai_1.expect)(result).to.an('object');
                (0, chai_1.expect)(result.soal).to.a('string');
                (0, chai_1.expect)(result.jawaban).to.a('string');
                return done();
    ...
    describe('Siapakahaku', () => {
        it('siapakahaku', done => {
            (0, index_1.siapakahaku)().then(result => {
                (0, chai_1.expect)(result).to.an('object');
                (0, chai_1.expect)(result.index).to.a('number');
                (0, chai_1.expect)(result.soal).to.a('string');
                (0, chai_1.expect)(result.jawaban).to.a('string');
        ...
        it('siapakahaku JSON', done => {
            let res = index_1.siapakahakujson;
            (0, chai_1.expect)(res).to.an('array');
    ...
    describe('Susunkata', () => {
        it('susunkata', done => {
            (0, index_1.susunkata)().then(result => {
                (0, chai_1.expect)(result).to.an('object');
                (0, chai_1.expect)(result.index).to.a('number');
                (0, chai_1.expect)(result.soal).to.a('string');
    ...
    describe('Tebakbendera', () => {
        it('tebakbendera', done => {
            (0, index_1.tebakbendera)().then(result => {
                (0, chai_1.expect)(result).to.an('object');
        ...
        it('tebakbendera JSON', done => {
            let res = index_1.tebakbenderajson;
            (0, chai_1.expect)(res).to.an('array');
    ...
    describe('Tebak Kabupaten', () => {
        it('tebakkabupaten', done => {
            (0, index_1.tebakkabupaten)().then(result => {
                (0, chai_1.expect)(result).to.an('object');
                (0, chai_1.expect)(result.index).to.a('number');
        ...
        it('tebakkabupaten JSON', done => {
            let res = index_1.tebakkabupatenjson;
            (0, chai_1.expect)(res).to.an('array');
    ...
    describe('Tebak Lirik', () => {
        it('tebaklirik', done => {
            (0, index_1.tebaklirik)().then(result => {
                (0, chai_1.expect)(result).to.an('object');
                (0, chai_1.expect)(result.soal).to.a('string');
                (0, chai_1.expect)(result.jawaban).to.a('string');
                return done();
        ...
        it('tebaklirik JSON', done => {
            let res = index_1.tebaklirikjson;
            (0, chai_1.expect)(res).to.an('array');
    ...
    describe('Tebak Tebakan', () => {
        it('tebaktebakan', done => {
            (0, index_1.tebaktebakan)().then(result => {
                (0, chai_1.expect)(result).to.an('object');
                (0, chai_1.expect)(result.soal).to.a('string');
                (0, chai_1.expect)(result.jawaban).to.a('string');
                return done();
        ...
        it('tebaktebakan JSON', done => {
            let res = index_1.tebaktebakanjson;
            (0, chai_1.expect)(res).to.an('array');
