...
describe('Encryptions', () => {
    describe('Base64', () => {
        it('From string to base64', done => {
            try {
                const res = (0, index_1.toBase64)('Hello World!!');
        ...
        it('from base64 to string', done => {
            try {
                const res = (0, index_1.fromBase64ToString)('SGVsbG8gV29ybGQhIQ==');
                (0, chai_1.expect)(res).to.be.a('string');
    ...
    describe('Crypto', () => {
        it('randomUUID', done => {
            try {
                const res = (0, index_1.randomUUID)();
                (0, chai_1.expect)(res).to.be.a('string');
                return done();
            }
            catch (e) {
        ...
        it('randomBytes', done => {
            try {
                const res = (0, index_1.randomBytes)(16);
                (0, chai_1.expect)(res).to.be.a('string');
                return done();
            }
            catch (e) {
        ...
        it('createHash', done => {
            try {
                const res = (0, index_1.createHash)('sha256', 'Hello world!!');
                (0, chai_1.expect)(res).to.be.a('string');
